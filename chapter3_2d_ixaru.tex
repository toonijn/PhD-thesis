...
\todo{example with large eigenvalues}

\todo{prepare for examples in next chapter}
...
\begin{table}
  \centering
  \begin{tabular}{l|n{2}{7}n{2}{10}n{1}{1}}
                    & {Ixaru\cite{ixaru_new_2010}} & {Our results} & {$\Delta$} \\
    \hline
    $E_{0}$         & 3.1959181                    & 3.1959181112  & 1.1e-8     \\
    $E_{1} = E_{2}$ & 5.5267439                    & 5.5267440748  & 1.7e-7     \\
    $E_{3}$         & 7.5578033                    & 7.5578035728  & 2.7e-7     \\
    $E_{4}$         & 8.0312723                    & 8.0312723637  & 6.4e-8     \\
    $E_{5}$         & 8.4445814                    & 8.4445817565  & 3.6e-7     \\
    $E_{6} = E_{7}$ & 9.9280611                    & 9.9280611619  & 6.2e-8     \\
    $E_{8} = E_{9}$ & 11.3118171                   & 11.311817614  & 5.1e-7     \\
    $E_{10}$        & 12.1032536                   & 12.103253445  & 1.6e-7     \\
    $E_{11}$        & 12.2011790                   & 12.201179825  & 8.3e-7     \\
    $E_{12}$        & 13.3323313                   & 13.332332972  & 1.7e-6
  \end{tabular}
