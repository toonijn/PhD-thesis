...
\todo{Should we say something about scaling in between sectors?}
...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{rlrl|rl|}
      ...
      \multicolumn{1}{|c}{\parbox[c]{\hoWidth}{\includegraphics[width=\linewidth]{img/chapter3/counting/harmonic/2a.pdf}}} & $ \begin{matrix} \mathbf{u_{1,1}} \vspace{5pt}\\ \scalebox{1.5}{$\mathbf{1}$} \end{matrix} $                        & \multicolumn{1}{|c}{\parbox[c]{\hoWidth}{\includegraphics[width=\linewidth]{img/chapter3/counting/harmonic/4a.pdf}}} & $ \begin{matrix} \mathbf{u_{1,2}} \vspace{5pt}\\ \scalebox{1.5}{$\mathbf{2}$} \end{matrix} $ & \parbox[c]{\hoWidth}{\vspace{2pt}\includegraphics[width=\linewidth]{img/chapter3/counting/harmonic/6a.pdf}\vspace{2pt}} & $ \begin{matrix} \mathbf{u_{2,2}} \vspace{5pt}\\ \scalebox{1.5}{$\mathbf{4}$} \end{matrix} $  \\
      \cline{1-6}                                                                                        &                                                      & \multicolumn{1}{|c}{\parbox[c]{\hoWidth}{\includegraphics[width=\linewidth]{img/chapter3/counting/harmonic/4b.pdf}}} & $ \begin{matrix} \mathbf{u_{2,1}} \vspace{5pt}\\ \scalebox{1.5}{$\mathbf{2}$} \end{matrix} $ & \parbox[c]{\hoWidth}{\vspace{2pt}\includegraphics[width=\linewidth]{img/chapter3/counting/harmonic/6b.pdf}\vspace{2pt}} & $  \begin{matrix} u_{1,3} \vspace{5pt}\\ \scalebox{1.5}{$3$} \end{matrix} $ \\
      \cline{3-6}                                                                                        &                                                      &                                                                                                    &                               & \parbox[c]{\hoWidth}{\vspace{2pt}\includegraphics[width=\linewidth]{img/chapter3/counting/harmonic/6c.pdf}\vspace{2pt}} & $ \begin{matrix} u_{3,1} \vspace{5pt}\\ \scalebox{1.5}{$3$} \end{matrix} $  \\
      \cline{5-6}
    \end{tabular}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\linewidth]{img/chapter3/counting/harmonic_3d.pdf}
...
Before stating the main theorem some definitions are needed. These will simplify the notation and proof of our results.
\begin{definition}
...
Before proving the main result of this paper, let us already state the theorem.
...
\begin{theorem}[Baeyens, Van Daele and Vernaeve 2022]\label{col:counting_eigenvalues}
...
A straightforward example is to look at the sequence of concentric discs $\Omega_\epsilon$ of radius $R = \epsilon$. From the theory with Bessel functions, we know that if $\lambda_{i}$ is the $i^\text{th}$ eigenvalue on the unit disc, then $\frac{\lambda_{i}}{R^2}$ is the $i^\text{th}$ eigenvalue on the disc with radius $R$. It is obvious that the values $\frac{\lambda_{i}}{R^2}$ as a function of $R$, are continuous, decreasing, and unbounded as $R \to 0^{+}$.
