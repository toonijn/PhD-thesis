...
\nlparagraph{Transforming the problem onto a rectangular domain}
...
\nlparagraph{A specialized numerical method}
...
\nlparagraph{Analysis of eigenvalues in relation to the domain}
