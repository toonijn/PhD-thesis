...
\longchapter[2D shooting method]{A shooting method for \twoD{} time-independent Schrödinger equations}\label{cha:c3}
...
\todo{Rewrite for improved figures}
...
Upon close inspection of table~\ref{tab:ixaru_eigenvalues}, we remark that our results agree with these from~\cite{ixaru_new_2010} to all digits.
