...
$$
    y'' = (V_i - \lambda) y\text{.}
$$
These analytical solutions $\psi_i(x)$ have the following structure.
$$
    \psi_i(x) = \begin{cases}
...
\todo{An example about shooting? Convergence speed graph?}
...
\todo{An example of the Prüfer-curves.}
...
\subsection{Coffey-Evans}\label{sec:c2_numerical_experiments_coffey_evans}
