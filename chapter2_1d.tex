...
\begin{theorem}\label{the:c2_kth_eigen_k_roots}
    The $k^\text{th}$ eigenfunction has $k$ zeros.
\end{theorem}
\begin{proof}
\todo{}
\end{proof}
...
For this we remember theorem \ref{the:c2_kth_eigen_k_roots}. To know the index of the eigenvalue we can `simply' count the number of roots the corresponding eigenfunction has.

\todo{Formalize Prüfer transformation\cite{pruefer_neue_1926}}
