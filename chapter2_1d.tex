...
\begin{table}
    \begin{center}
        \begin{tabular}[]{rrr}
            ...
            \bottomrule
        \end{tabular}
        \caption{The first 10 eigenvalues for the truncated hydrogen problem~(\ref{equ:c2_truncated_hydrogen}), the execution times and the errors obtained with \matslise{2} and \pyslise{} for a tolerance of $10^{-8}$.}\label{tab:c2_tab7}
    \end{center}
\end{table}
