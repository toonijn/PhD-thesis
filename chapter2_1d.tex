...
To avoid this, many interpreted languages (for example \lpython{}, \javascript{}, \matlab{}\dots) have such a garbage collector build in. Even some compiled languages (such as \java{} or \csharp{}) do memory management with a garbage collector. But this is not the only way to do memory management, \rust{} for example, keeps track of which memory is used, at compile time with what they call \emph{lifetimes}. \texttt{C} and \cpp on the other hand, have no memory management build in, these languages rely on the programmer to clean up after themselves.
...
\subsection{}\label{a-new-implementation}
...
\todo{This is a copy from our article: rework}
